...
//@$data1 = mysql_query("select obdobi from zpracovana_dochazka where export='NE' group by obdobi order by obdobi ASC") or Die(MySQL_Error());   pouze otevøená období
@$data1 = mysql_query("select obdobi from zpracovana_dochazka group by obdobi order by obdobi ASC") or Die(MySQL_Error());
...
$casstredisko=mysql_result($zamestnanci,$cykl,17);
